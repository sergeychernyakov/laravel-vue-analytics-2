          ...
          <b-card>
            <b-row class="mb-2">
              <b-col
                ...
                class="mb-1"
              >
                <strong>Full Name : </strong>{{ row.item.title}}
              </b-col>
              <b-col
                md="4"
                class="mb-1"
              >
                <strong>Post : </strong>{{ row.item.sub_title }}
              </b-col>
              <b-col
                md="4"
                class="mb-1"
...
export default {
  ...
  data() {
    return {
      fields: ['show_details', 'increment_id', { key: 'avatar', label: 'Avatar' }, 'component', 'created_at', 'customer_email', 'grand_total', { key: 'status', label: 'Status' }],
