...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    axios.get('/api/auth/content').then(function (response) {
  ...
  beforeCreate: function beforeCreate() {
    ...
    axios.get('/api/auth/content').then(function (response) {
      _this2.items = response.data.story.content.body;
    });
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      optionsLocal: JSON.parse(JSON.stringify(this.data)),
      profileFile: null
    };
  },
  methods: {
    resetForm: function resetForm() {
      this.optionsLocal = JSON.parse(JSON.stringify(this.data));
    }
  },
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.optionsLocal.customer_firstname,
                          callback: function($$v) {
                            _vm.$set(
                              _vm.optionsLocal,
                              "customer_firstname",
                          ...
                          expression: "optionsLocal.customer_firstname"
                        }
                      })
                    ],
                    1
