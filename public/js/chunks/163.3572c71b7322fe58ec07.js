...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('/api/auth/content').then(function (response) {
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.options.new,
                          callback: function($$v) {
                            _vm.$set(_vm.options, "new", $$v)
                          },
                          expression: "options.new"
                        }
                      })
                    ],
                    1
