...
/***/ "./frontend/src/views/orders/code.js":
/*!*******************************************!*\
  !*** ./frontend/src/views/orders/code.js ***!
  \*******************************************/
...
/* harmony import */ var _code__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./code */ "./frontend/src/views/orders/code.js");
//
//
//
//
  ...
  data: function data() {
    return {
      fields: ['show_details', 'increment_id', {
        key: 'avatar',
        label: 'Avatar'
      }, 'full_name', 'created_at', 'customer_email', 'grand_total', 'grand_total', 'experience', {
        key: 'status',
        label: 'Status'
      }],
...
/* harmony import */ var _OrderTable_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OrderTable.vue */ "./frontend/src/views/orders/OrderTable.vue");
//
//
//
//
        ...
        [
          _c("b-table", {
            ...
            attrs: {
              items: _vm.items,
              fields: _vm.fields,
              to: { name: "apps-users-view", params: { id: _vm.data.item.id } },
              striped: "",
              responsive: ""
            },
            scopedSlots: _vm._u([
