...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeCreate: function beforeCreate() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('/api/auth/omni').then(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/auth/omni/1').then(function (response) {
      _this.items = response.data.items;
    });
  },
  data: function data() {
  ...
  methods: {
    resetForm: function resetForm() {
      this.options = JSON.parse(JSON.stringify(this.generalData));
    }
  },
