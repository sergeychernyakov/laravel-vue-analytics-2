...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'productStoreModule.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var userData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(null);
    var USER_APP_STORE_MODULE_NAME = 'app-user'; // Register module

    if (!_store__WEBPACK_IMPORTED_MODULE_7__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_7__["default"].registerModule(USER_APP_STORE_MODULE_NAME, !(function webpackMissingModule() { var e = new Error("Cannot find module 'productStoreModule.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // UnRegister on leave
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.items.customer_email,
                          callback: function($$v) {
                            _vm.$set(_vm.items, "customer_email", $$v)
                          },
                          expression: "items.customer_email"
                        }
                      })
                    ],
                    1
